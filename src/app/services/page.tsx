         ...
         <ThemeBackground heading="Our Services" image={image}>
            <div className="flex flex-col items-center space-y-4">
               <p className="font-medium">
                  Discover how our services can make your local business stand out from the crowd.
                  We provide tailored solutions to boost your brands visibility, drive growth, and
            ...
            <div className="my-12">
               ...
               <div className="grid md:grid-cols-2 gap-6 my-16">
                  {services_provided?.map((item: any, idx: number) => (
                     <article
                        key={idx}
                        className="space-y-4 font-medium  text-blue bg-panel1 first:bg-panel2 first:text-white last:text-white last:bg-panel2  p-7 rounded-2xl"
                     >
                        ...
                        <ul className="my-16">
                           {item.list.map((l: string, i: number) => (
                              <li
                                 key={i}
                                 className="flex w-full gap-2 text-lg items-center font-bold"
                              >
                                 <FaCircleDot className="text-white" />
                                 {l}
                              </li>
                           ))}
                        </ul>
