...
export const Strip = () => {
  return (
    <div className='bg-secondary rounded-3xl p-6 mx-36 flex gap-8 justify-between items-center mb-6'>
        ...
        <div className="text-3xl font-black uppercase text-themeColor leading-6 font-mitr w-1/2">digital & strategy</div>
        ...
        <i className="w-20 h-20 rounded-full bg-themeColor flex items-center justify-center flex-grow-1"><IoMdArrowUp className="rotate-45 text-5xl text-secondary"/> </i> 
    </div>
  )
}
