...
const Navbar = () => {
   ...
   return (
      <nav
         className={`fixed py-4 w-full top-0 lg:py-0 z-50 bg-themeColor shadow-md shadow-black/10`}
      >
         <MediaQuery>
            <div className="w-full flex justify-between items-center h-full relative">
               ...
               >
                  <Link href="/" className="flex gap-2 items-center ">
                     ...
                     <h1 className="text-white font-semibold font-mitr text-md sm:text-xl uppercase">
                        Nextgen Interface
                     </h1>
                  </Link>
               </motion.div>
