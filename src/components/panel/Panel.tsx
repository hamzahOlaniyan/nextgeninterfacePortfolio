    ...
    <div className="h-full py-24">
      ...
      <div className="w-full flex flex-col-reverse md:grid grid-cols-[1fr_2fr] gap-6 items-end">
        <div className="flex gap-6 items-center">
          <Link href='/services' className="font-semibold text-lg hover:underline">See all services</Link>
          <HiArrowLongRight/>
        </div>
        <div className="space-y-6">
          <h1 className='text-2xl font-mitr uppercase font-black text-label italic'>* you know what?!</h1>
